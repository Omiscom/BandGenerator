...
app.post("/submit", (req, res) => {
  ...
  const Adj = Math.floor(Math.random() * adj.length);
 

  const Noun = Math.floor(Math.random() * noun.length);


  const some = adj[Adj] + "  " + noun[Noun];

  res.render("index.ejs", {currentWords:some})
